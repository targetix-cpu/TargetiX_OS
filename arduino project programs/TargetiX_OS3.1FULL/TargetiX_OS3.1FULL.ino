...
const char* firmwareURL =
  "https://raw.githubusercontent.com/ua2026-hash/TargetiX_OS/main/firmware_sl2.bin";

// ====== Wi-Fi AP ======
const char* ssid = "TargetiX_SL2";
...
if (request.indexOf("/api/ready") >= 0) {
  ...
  if (
    ...
    client.println("Location: http://192.168.2.2/");
    client.println("Connection: close");
    client.println();
